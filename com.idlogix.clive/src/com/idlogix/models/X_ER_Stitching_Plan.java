...
/** Generated Model for ER_Stitching_Plan
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_ER_Stitching_Plan extends PO implements I_ER_Stitching_Plan, I_Persistent 
{
    ...
    public X_ER_Stitching_Plan (Properties ctx, int ER_Stitching_Plan_ID, String trxName)
    {
      super (ctx, ER_Stitching_Plan_ID, trxName);
      /** if (ER_Stitching_Plan_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_ER_Stitching_Plan (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ER_Stitching_Plan[")
	...
	/** Set Stitching Plan.
		@param ER_Stitching_Plan_ID Stitching Plan	  */
	public void setER_Stitching_Plan_ID (int ER_Stitching_Plan_ID)
	{
		if (ER_Stitching_Plan_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ER_Stitching_Plan_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ER_Stitching_Plan_ID, Integer.valueOf(ER_Stitching_Plan_ID));
	}

	/** Get Stitching Plan.
		@return Stitching Plan	  */
	public int getER_Stitching_Plan_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ER_Stitching_Plan_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set ER_Stitching_Plan_UU.
		@param ER_Stitching_Plan_UU ER_Stitching_Plan_UU	  */
	public void setER_Stitching_Plan_UU (String ER_Stitching_Plan_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ER_Stitching_Plan_UU, ER_Stitching_Plan_UU);
	}

	/** Get ER_Stitching_Plan_UU.
		@return ER_Stitching_Plan_UU	  */
	public String getER_Stitching_Plan_UU () 
	{
		return (String)get_Value(COLUMNNAME_ER_Stitching_Plan_UU);
	}
