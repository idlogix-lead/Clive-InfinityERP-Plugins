...
/** Generated Interface for ER_LaborActivityLine
 *  @author iDempiere (generated) 
 *  @version Release 7.1
 */
@SuppressWarnings("all")
public interface I_ER_LaborActivityLine 
{

    /** TableName=ER_LaborActivityLine */
    public static final String Table_Name = "ER_LaborActivityLine";
    ...
    /** Column name ER_Coupon_ID */
    public static final String COLUMNNAME_ER_Coupon_ID = "ER_Coupon_ID";
    ...
    /** Column name ER_LaborActivity_ID */
    public static final String COLUMNNAME_ER_LaborActivity_ID = "ER_LaborActivity_ID";
    ...
    /** Column name ER_LaborActivityLine_ID */
    public static final String COLUMNNAME_ER_LaborActivityLine_ID = "ER_LaborActivityLine_ID";
    ...
    /** Column name ER_LaborActivityLine_UU */
    public static final String COLUMNNAME_ER_LaborActivityLine_UU = "ER_LaborActivityLine_UU";
