...
/** Generated Model for ER_StrobelHdr
 *  @author iDempiere (generated) 
 *  @version Release 8.2 - $Id$ */
public class X_ER_StrobelHdr extends PO implements I_ER_StrobelHdr, I_Persistent 
{
    ...
    public X_ER_StrobelHdr (Properties ctx, int ER_StrobelHdr_ID, String trxName)
    {
      super (ctx, ER_StrobelHdr_ID, trxName);
      /** if (ER_StrobelHdr_ID == 0)
        {
			setER_StrobelHdr_ID (0);
			setProcessed (false);
        } */
    }

    /** Load Constructor */
    public X_ER_StrobelHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ER_StrobelHdr[")
	...
	/** Set Strobel.
		@param ER_StrobelHdr_ID Strobel	  */
	public void setER_StrobelHdr_ID (int ER_StrobelHdr_ID)
	{
		if (ER_StrobelHdr_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ER_StrobelHdr_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ER_StrobelHdr_ID, Integer.valueOf(ER_StrobelHdr_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ER_StrobelHdr_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set ER_StrobelHdr_UU.
		@param ER_StrobelHdr_UU ER_StrobelHdr_UU	  */
	public void setER_StrobelHdr_UU (String ER_StrobelHdr_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ER_StrobelHdr_UU, ER_StrobelHdr_UU);
	}

	/** Get ER_StrobelHdr_UU.
		@return ER_StrobelHdr_UU	  */
	public String getER_StrobelHdr_UU () 
	{
		return (String)get_Value(COLUMNNAME_ER_StrobelHdr_UU);
	}
