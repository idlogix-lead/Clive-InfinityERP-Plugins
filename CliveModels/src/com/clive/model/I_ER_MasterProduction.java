...
/** Generated Interface for ER_MasterProduction
 *  @author iDempiere (generated) 
 *  @version Release 7.1
 */
@SuppressWarnings("all")
public interface I_ER_MasterProduction 
{

    /** TableName=ER_MasterProduction */
    public static final String Table_Name = "ER_MasterProduction";
    ...
    /** Column name AddMasterProductionLine */
    public static final String COLUMNNAME_AddMasterProductionLine = "AddMasterProductionLine";
    ...
    public static final String COLUMNNAME_DateCompletion = "DateCompletion";
    ...
    /** Column name ER_MasterProduction_UU */
    public static final String COLUMNNAME_ER_MasterProduction_UU = "ER_MasterProduction_UU";
