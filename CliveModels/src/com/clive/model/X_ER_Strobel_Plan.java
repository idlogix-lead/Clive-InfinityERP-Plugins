...
/** Generated Model for ER_Strobel_Plan
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_ER_Strobel_Plan extends PO implements I_ER_Strobel_Plan, I_Persistent 
{
    ...
    public X_ER_Strobel_Plan (Properties ctx, int ER_Strobel_Plan_ID, String trxName)
    {
      super (ctx, ER_Strobel_Plan_ID, trxName);
      /** if (ER_Strobel_Plan_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_ER_Strobel_Plan (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ER_Strobel_Plan[")
	...
	/** Set Strobel Plan.
		@param ER_Strobel_Plan_ID Strobel Plan	  */
	public void setER_Strobel_Plan_ID (int ER_Strobel_Plan_ID)
	{
		if (ER_Strobel_Plan_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_ER_Strobel_Plan_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_ER_Strobel_Plan_ID, Integer.valueOf(ER_Strobel_Plan_ID));
	}

	/** Get Strobel Plan.
		@return Strobel Plan	  */
	public int getER_Strobel_Plan_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ER_Strobel_Plan_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set ER_Strobel_Plan_UU.
		@param ER_Strobel_Plan_UU ER_Strobel_Plan_UU	  */
	public void setER_Strobel_Plan_UU (String ER_Strobel_Plan_UU)
	{
		set_ValueNoCheck (COLUMNNAME_ER_Strobel_Plan_UU, ER_Strobel_Plan_UU);
	}

	/** Get ER_Strobel_Plan_UU.
		@return ER_Strobel_Plan_UU	  */
	public String getER_Strobel_Plan_UU () 
	{
		return (String)get_Value(COLUMNNAME_ER_Strobel_Plan_UU);
	}
